...
| 09-06-2026 | ChatGPT 5.6-Luna | "What is wrong with this table format" + copied and pasted by incorrect formatted dependency table into chat. (it gave me a corrected format that formed a table in a .md file) | I looked through the data to ensure that none of my wording or data was changed by chat. All of my written words were the same it just added an extra line where I didn't put one originally | I copied and pasted the correctly formatted table data into my dependency-checks.md to fix the broken table | I looked through each box and compared word for word what I originally wrote in the data to ensure nothing was changed without my knowing |
| 09-20-2026 | ChatGPT 5.6-Luna | "Can you reformat and enhance my non-functional requirements to meet the expectations of my professor" + inserted instructions on Non-functional requirements from Milestone 4 assignment as well as my already written 16 non-functional requirements. ChatGPT gave me an updated list chart format with more indepth methods and parameters as well as an additional 7 non-funcitonal requirements. I noticed that my wording was changed in a couple of the non-functional requirements so I read through to determine if they still met the standard of what I was trying to say. | I kept the updated and enhanced version that Chat GPT wrote because it sounded more technical and professional. | I reread everything that ChatGPT enhanced to ensure that it still met the standard that I needed it to | I looked at the before and after to ensure that the points were still being made and the requirements were fundamentally the same |
